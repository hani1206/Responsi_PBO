...
public class ViewSimpanan extends JFrame{
    JLabel title = new JLabel("BARANG SIMPANAN");
    JLabel title2 = new JLabel("BARANG SIMPANAN");
    ...
    public Object[] namaKolom = {"Simpanan","Kategori","Pengguna","Nama Barang","Jumlah"};
    ...
    ImageIcon img = new ImageIcon("src\\Assets\\cat.png");
