...
public class ViewLogout extends JFrame{
    JLabel title = new JLabel("TERIMAKASIH! DATANG KEMBALI!");
    JLabel title2 = new JLabel("123180144");
    ...
    ImageIcon img = new ImageIcon("src\\Assets\\logout.png");
    ...
    public ViewLogout(){
        ...
        add(title);
        title.setBounds(250,50,800,50);
        title.setFont(new Font("Helvetica",Font.BOLD,50));
        add(title2);
        title2.setBounds(500,110,500,50);
