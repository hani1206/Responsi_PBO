...
public class ViewEditSimpanan extends JFrame {
    ...
    JLabel lSimpanan = new JLabel("Simpanan: ");
    public JComboBox cbSimpanan = new JComboBox();
    ...
    JLabel lPengguna = new JLabel("Pengguna: ");
    public JComboBox cbPengguna = new JComboBox();
    ...
    public Object[] namaKolom= {"id_simpanan", "kategori","pengguna", "nama_barang", "jumlah"};
    public ViewEditSimpanan(){
        ...
        add(lSimpanan);
        lSimpanan.setBounds(150,180,200,35);
        lSimpanan.setFont(font2);
        add(cbSimpanan);
        cbSimpanan.setBounds(330,180,300,35);
        ...
        lPengguna.setBounds(330,330,200,35);
        add(cbPengguna);
        cbPengguna.setBounds(430,330,200,35);
    ...
    public String getSimpanan(){return cbSimpanan.getSelectedItem().toString(); }
    public String getJumlah(){
        return tfJumlah.getText();
    }
    public String getKategori(){ return cbKategori.getSelectedItem().toString();}
    public String getPengguna(){ return cbPengguna.getSelectedItem().toString();}
